...
function ProductList() {
    ...
    const [addedToCart, setAddedToCart] = useState({}); // State for cart management
    ...
    const handleAddToCart = (plant) => {
        dispatch(addItem(plant)); // Dispatch add to cart action
        setAddedToCart((prevState) => ({
            ...prevState,
            [plant.name]: (prevState[plant.name] || 0) + 1, // Track added plants
        }));
    };
        ...
        <div>
            ...
            <div className="navbar" style={styleObj}>
                ...
                <div style={navLinksStyle}>
                    <div> 
                        <a href="#" style={linkStyle}>Plants</a>
                    </div>
                    <div> 
                                ...
                                {category.plants.map((plant, idx) => (
                                    <div key={idx} className="plant-card">
                                        ...
                                        <button 
                                            ...
                                            disabled={addedToCart[plant.name] > 0} // Disable button if plant is already added
                                        >
                                            {addedToCart[plant.name] > 0 ? 'Added' : 'Add to Cart'}
                                        </button>
                                    </div>
                                ))}
                            </div>
